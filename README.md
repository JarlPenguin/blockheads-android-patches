...
### 2. `webview-suspend-freeze-fix.patch`
...
* Fixes fatal ANR (Application Not Responding) freezes when suspending/resuming the game, and stops `SIGTRAP` crashes when opening pages through the WebView (like welcome messages and the Help/Credits page).
